...
function addinput
{
  ...
  cp "$image_file" "input/staging/$filename.png"
  cp "$resources_file" "input/staging/$filename.resources"
  echo "Generated by $USER" > "input/staging/$filename.txt"
}
