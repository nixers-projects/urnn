...
main(int argc, char* argv[])
{
	if (argc != 3) {
		...
		const float desired_error = (const float) 0.003; // be kinda tolerant
		const unsigned int max_epochs = 2000000; // allow for a long run
		const unsigned int epochs_between_reports = 30000;
